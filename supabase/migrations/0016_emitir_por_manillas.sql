-- ============================================================
-- 0016 — una mesa emite una entrada por persona que entra con ella
--
-- Hasta 0015 todo `tipo_entrada` era una persona, así que emitir
-- `cantidad` entradas alcanzaba. Ahora "Branca Lounge" entra 10: emitir una
-- sola deja al grupo afuera en la puerta.
--
-- La puerta escanea personas, no productos. Mismo criterio que ya usaba la
-- mesa del plano, que emitía una por manilla.
-- ============================================================
